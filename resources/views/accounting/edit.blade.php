...
@section('title',"Mühasibatlıq - Ödəniş redaktə etmə bölməsi")
@section("content")
    <!-- Main content -->
                ...
                <div class="page-header-content d-lg-flex">
                    <div class="d-flex">
                        <h4 class="page-title mb-0">
                            Mühasibatlıq - <span class="fw-normal">Ödəniş redaktə etmə bölməsi</span>
                        </h4>
                    ...
                    <div class="col-xl-6" style="margin: auto">
                        <div class="card">
                            ...
                            <div class="card-body pb-0">
                                <div class="row">
                                    <div class="col-xl-12">
                                        <form id="id" onsubmit="btnBlock()" action="{{ route('accountingEditPost',[$data->id,'edit']) }}"
                                              method="POST">
                                            @csrf
                                            <div class="mb-3">
                                                <label for="title" class="col-form-label">Başlıq(*):</label>
                                                <input type="text" required="required" value="{{ $data->title }}" class="form-control" name="title"
                                                       id="title">
                                            </div>
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="number" step="0.01" required="required"
                                                           class="form-control" value="{{ $data->amount }}" name="amount" id="amount">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="type" class="col-form-label">Tip:</label>
                                                    <select name="type" id="type" class="form-control">
                                                        <option {{ $data->type == "income" ? 'selected="selected"' : '' }} value="income">Mədaxil</option>
                                                        <option {{ $data->type == "expense" ? 'selected="selected"' : '' }} value="expense">Məxaric</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <input type="date" max="{{ date("Y-m-d") }}" required="required"
                                                       class="form-control" value="{{ $data->payment_date }}" name="payment_date" id="payment_date">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <button id="btn_submit" class="btn btn-info float-end">Redaktə et</button>
                                            </div>
